...
class Permohonan_Produk_Distributor extends CI_Model {
  ...
  public function get_data($column = '*')
  {
    ...
    $this->db->join('permohonan_produk_distributor_status b', 'a.id = b.id_permohonan AND a.status = b.status');
  ...
  public function update($id, $data = array())
  {
    $this->db->set($data);
    $this->db->where('id', $id);
    $query = $this->db->get_compiled_update('permohonan_produk_distributor');
    $this->db->query($query);
  }
}