    ...
    <script type="text/javascript" src="<?php echo base_url()?>/assets/assets_in/select2.full.min.js"></script>
    ...
    <script type="text/javascript" src="<?php echo base_url()?>/assets/assets_in/components-modal.min.js"></script>
