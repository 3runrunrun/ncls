      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a class="padding-none" href="https://pixinvent.com/bootstrap-admin-template/robust/html/ltr/horizontal-top-icon-menu-template/index.html" class="navbar-brand nav-link">
              <img alt="branding logo" src="<?php echo base_url() ?>/img/logo.png" data-expand="../../../app-assets/images/logo/robust-logo-light.png" data-collapse="../../../app-assets/images/logo/robust-logo-small.png" class="brand-logo logo-nucleus"></a></li>
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            <ul class="nav navbar-nav float-xs-right">
              <li class="dropdown dropdown-user nav-item"><a href="https://pixinvent.com/bootstrap-admin-template/robust/html/ltr/horizontal-top-icon-menu-template/#" data-toggle="dropdown" class="nav-link dropdown-user-link"><span class="user-name">John Doe</span></a>
                <div class="dropdown-menu dropdown-menu-right">
                  <a href="https://pixinvent.com/bootstrap-admin-template/robust/html/ltr/horizontal-top-icon-menu-template/#" class="dropdown-item"><i class="fa fa-user"></i> My Profile</a>
                  <div class="dropdown-divider"></div><a href="https://pixinvent.com/bootstrap-admin-template/robust/html/ltr/horizontal-top-icon-menu-template/#" class="dropdown-item"><i class="fa fa-sign-out"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
    ...
    <div id="sticky-wrapper" class="sticky-wrapper" style="height: 94px;"><div role="navigation" data-menu="menu-wrapper" class="header-navbar navbar navbar-horizontal navbar-fixed bg-blue navbar-without-dd-arrow navbar-bordered navbar-shadow">
      ...
      <div data-menu="menu-container" class="navbar-container main-menu-content">
        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="nav navbar-nav">
          <li data-menu="dropdown" class="dropdown nav-item "><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="fa fa-tachometer"></i><span data-i18n="nav.dash.main"></span>Dashboard</a>
          </li>
          <li data-menu="dropdown" class="dropdown nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link menu"><i class="fa fa-user"></i><span data-i18n="nav.templates.main">Master</span></a>
            <ul class="dropdown-menu">
              ...
              <li data-menu=""><a href="<?php echo site_url() ?>/master-produk" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-tablet"></i>Master Produk</a>
              </li>
            </ul>
          </li>
          <li data-menu="dropdown" class="dropdown nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="fa fa-money"></i><span data-i18n="nav.layouts.temp">Transaction</span></a>
            <ul class="dropdown-menu">
              <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-cube"></i> Subdist</a>
              </li>
              <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-cogs"></i> Prospect Intensifikasi Ekstensifikasi</a>
              </li>
              ...
              <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-cube"></i> Prospect RTD</a>
              </li>
              <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-check-square"></i> Prospect Marketing Activity</a>
              </li>
              <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-check-square"></i> Evaluasi Target Customer</a>
              </li>
              <li data-menu="dropdown-submenu" class="dropdown dropdown-submenu">
                <a href="#" data-toggle="dropdown" class="dropdown-item dropdown-toggle "><i class="fa fa-file"></i>Monthly call plan </a>
                <ul class="dropdown-menu">
                  <li data-menu="" ><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-exchange"></i> Target call plan spv</a>
                  </li>
                  <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i  class="fa fa-file"></i>Evaluasi call plan spv</a>
                  </li>
                  <li data-menu="" ><a href="#" data-toggle="dropdown" class="dropdown-item"> <i class="fa fa-user"></i>Target call plan DSM</a>
                  </li>
                  <li data-menu="" ><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-exchange"></i>Evaluasi call plan DSM</a>
                  </li>
                </ul>
              </li>
               <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-check-square"></i> WRP</a>
              </li>
               <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-check-square"></i> Promo Trial</a>
              </li>
              <li data-menu="dropdown-submenu" class="dropdown dropdown-submenu">
                <a href="#" data-toggle="dropdown" class="dropdown-item dropdown-toggle"><i class="fa fa-envelope"></i>Surat Permohonan Disc. On &amp; Off Faktur</a>
                <ul class="dropdown-menu">
          ...
          <li data-menu="dropdown" class="dropdown nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link"><i class="fa fa-file"></i><span data-i18n="nav.category.general"> Fitur Report</span></a>
            <ul class="dropdown-menu">
              <li data-menu="dropdown-submenu" class="dropdown dropdown-submenu"><a href="#" data-toggle="dropdown" class="dropdown-item dropdown-toggle"><i class=" fa fa-caret-down"></i>Daily Sales </a>
                <ul class="dropdown-menu">
                  <li data-menu="" ><a href="<?php echo site_url() ?>/Admin/daily_sales_product" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-exchange"></i> per Product</a>
                  </li>
                  <li data-menu=""><a href="<?php echo site_url() ?>/Admin/daily_sales_outlet" data-toggle="dropdown" class="dropdown-item"><i  class="fa fa-file"></i>per Sales</a>
                  </li>
                </ul>
              </li>
              <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-file"></i> Data Sales distributor dan jenis product (all area per year)</a>
              </li>
              <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-flag-o"></i> Data Stock Product (Pabrik ke nucleus)</a>
              </li>
              <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-word-o"></i>Data Stock Product (Nucleus ke distributor)</a>
              </li>
              <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-file"></i> Entry Breakdown analisa sales</a>
              </li>
              <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-at"></i> Laporan Pemindahan Sales (PR)</a>
              </li>
               <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-tablet"></i> Laporan Actual Sales per year</a>
              </li>
               <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-money"></i> Laporan Donasi</a>
              </li>
             <li data-menu="dropdown-submenu" class="dropdown dropdown-submenu"><a href="#" data-toggle="dropdown" class="dropdown-item dropdown-toggle"><i class=" fa fa-caret-down"></i>KLM (key loyalty management) Redflag, mvc, balance </a>
                <ul class="dropdown-menu">
                  <li data-menu="" ><a href="#" data-toggle="dropdown" class="dropdown-item"><i class="fa fa-exchange"></i> Sales (leveling )</a>
                  </li>
                  <li data-menu=""><a href="#" data-toggle="dropdown" class="dropdown-item"><i  class="fa fa-file"></i>Dana</a>
                  </li>
                </ul>
              </li>
            </ul>
