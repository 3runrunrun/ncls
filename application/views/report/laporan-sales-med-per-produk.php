        ...
        <div class="col-xs-12">
          <div class="card border-top-tosca">
            <div class="card-header no-border-bottom">
              <h4 class="card-title">Laporan Sales Med Rep per Produk</h4>
                ...
                <div class="table-responsive height-300 border-top-red">
                  <table class="table table-hover mb-0">
                      ...
                      <tbody>
                        <?php for($i = 0; $i < 5; $i++): ?>
                        <tr>
                          <td style="text-align: center !important"><?php echo rand(2130, 3232); ?></td>
                          <td><?php echo strtoupper('farmacrol forte'); ?></td>
                          <td style="text-align: center !important"><?php echo rand(105, 200); ?></td>
                          <td style="text-align: right !important"><?php echo number_format(rand(200000, 1000000), 0, ',', '.'); ?></td>
                          <td>
                            <div class="btn-group-vertical" role="group">
                              <a href="<?php echo site_url() ?>/detail-analisis-sales-per-produk" class="btn btn-primary">Detail</a>
                            </div>
                          </td>
                        </tr>
                        <?php endfor; ?>
