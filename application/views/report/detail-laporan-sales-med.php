        ...
        <div class="col-xs-12">
          <div class="card border-top-tosca">
            <div class="card-header no-border-bottom">
              <h4 class="card-title">Detail Laporan Sales Med Rep</h4>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select name="" class="form-control">
                            <option value="" selected disabled>Apotek Kimia Farma</option>
                          </select>
                        </div>
                      </div>
                      <!-- /outlet -->
                      <div class="form-group row">
                        <label class="label-control col-sm-4">Type</label>
                        <div class="col-sm-3">
                          <select name="" class="form-control select2" readonly>
                            <option value="" selected disabled>REG</option>
                            <option value=""></option>
                          </select>
                        </div>
                      </div>
                      ...
                      <table class="table table-bordered table-hover mb-0">
                          <thead>
                            <tr>
                              ...
                              <th width="40%" style="text-align: center !important">Nama Produk</th>
                          ...
                          <tbody>
                            ...
                            <tr class="row-barang">
                              ...
                              <td><?php echo strtoupper('farmacrol forte'); ?></td>
